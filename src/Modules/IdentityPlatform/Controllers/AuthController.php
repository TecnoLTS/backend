...
class AuthController {
    ...
    public function __construct() {
        ...
        $persistence = AuthSurfacePersistenceFactory::create($this->authSurface);
        $this->userRepository = $persistence->principal;
        $this->authSecurityRepository = $persistence->securityEvents;
        $this->passwordResetTokenRepository = $persistence->passwordResets;
        $this->contactMessageRepository = $persistence->contactRequests;
        $this->settingsRepository = $persistence->settings;
    }
    ...
    private function sessionLifetimeSecondsForRole(?string $role): int {
        try {
            return $this->settingsRepository->sessionTtlSecondsForRole($role);
