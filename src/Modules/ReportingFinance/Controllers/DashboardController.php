...
class DashboardController {
    ...
    public function __construct(
        ?SalesReportingPort $reports = null,
        ?DashboardAnalyticsPort $analytics = null
    ) {
    ...
    public function stats() {
        ...
        try {
            ...
            if ($scope === 'historical' || $scope === 'week' || $scope === 'year' || $scope === 'day' || $selectedDate) {
                $report = $this->reports->periodSummary($selectedMonth, $selectedDate, $scope, $selectedYear);
                ...
                $response = $this->analytics->fullDashboardStats($selectedMonth, $selectedDate, $scope, $includeReport);
            }
